...
public:
  ...
  // EOSType member functions

  /*
    using EOSType::press_from_valid_rho_eps_ye;
    using EOSType::csnd_from_valid_rho_eps_ye;
    using EOSType::temp_from_valid_rho_eps_ye;
    using EOSType::press_derivs_from_valid_rho_eps_ye;
    using EOSType::entropy_from_valid_rho_eps_ye;
    using EOSType::press_from_valid_rho_temp_ye;
    using EOSType::csnd_from_valid_rho_temp_ye;
    using EOSType::entropy_from_valid_rho_temp_ye;
    using EOSType::eps_from_valid_rho_temp_ye;
    using EOSType::range_eps_from_valid_rho_ye;
  */
