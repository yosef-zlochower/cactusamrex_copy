...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_WeylScal4_psis_calc_Nth_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(WeylScal4_psis_calc_Nth_SelectBCs);
  #else
...
static void WeylScal4_psis_calc_Nth_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    vecimin,vecimax, CCTK_REAL_VEC_SIZE)
  {
    ...
    CCTK_REAL_VEC Psi3rL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(rm1,kmadd(n1,kmul(nn,kmadd(kmadd(ToReal(-2),ltet1,n1),Ro111,knmsub(ltet2,Ro121,knmsub(ltet3,Ro131,kmadd(ksub(n2,ltet2),Ro211,kmul(Ro311,ksub(n3,ltet3))))))),kmadd(n2,kmadd(kmsub(ltet1,n2,kmul(ltet2,n1)),R4p1212,kmadd(kmsub(ltet1,n3,kmul(ltet3,n1)),R4p1213,kmadd(kmsub(ltet2,n3,kmul(ltet3,n2)),R4p1223,kmul(nn,kmadd(kmadd(ToReal(-2),ltet1,n1),Ro112,knmsub(ltet2,Ro122,knmsub(ltet3,Ro132,kmadd(ksub(n2,ltet2),Ro212,kmul(Ro312,ksub(n3,ltet3)))))))))),kmul(n3,kmadd(kmsub(ltet1,n2,kmul(ltet2,n1)),R4p1213,kmadd(kmsub(ltet1,n3,kmul(ltet3,n1)),R4p1313,kmadd(kmsub(ltet2,n3,kmul(ltet3,n2)),R4p1323,kmul(nn,kmadd(kmadd(ToReal(-2),ltet1,n1),Ro113,knmsub(ltet2,Ro123,knmsub(ltet3,Ro133,kmadd(ksub(n2,ltet2),Ro213,kmul(Ro313,ksub(n3,ltet3))))))))))))),kmadd(rm2,kmadd(n1,kmadd(kmsub(ltet2,n1,kmul(ltet1,n2)),R4p1212,kmadd(kmsub(ltet3,n1,kmul(ltet1,n3)),R4p1213,kmadd(kmsub(ltet3,n2,kmul(ltet2,n3)),R4p1223,kmul(nn,kmadd(ksub(n1,ltet1),Ro121,knmsub(ltet1,Ro211,kmadd(kmadd(ToReal(-2),ltet2,n2),Ro221,kmsub(ksub(n3,ltet3),Ro321,kmul(ltet3,Ro231))))))))),kmadd(n2,kmul(nn,kmadd(ksub(n1,ltet1),Ro122,knmsub(ltet1,Ro212,kmadd(kmadd(ToReal(-2),ltet2,n2),Ro222,kmsub(ksub(n3,ltet3),Ro322,kmul(ltet3,Ro232)))))),kmul(n3,kmadd(kmsub(ltet1,n2,kmul(ltet2,n1)),R4p1223,kmadd(kmsub(ltet1,n3,kmul(ltet3,n1)),R4p1323,kmadd(kmsub(ltet2,n3,kmul(ltet3,n2)),R4p2323,kmul(nn,kmadd(ksub(n1,ltet1),Ro123,knmsub(ltet1,Ro213,kmadd(kmadd(ToReal(-2),ltet2,n2),Ro223,kmsub(ksub(n3,ltet3),Ro323,kmul(ltet3,Ro233)))))))))))),kmadd(rm3,kmadd(n1,kmadd(kmsub(ltet2,n1,kmul(ltet1,n2)),R4p1213,kmadd(kmsub(ltet3,n1,kmul(ltet1,n3)),R4p1313,kmadd(kmsub(ltet3,n2,kmul(ltet2,n3)),R4p1323,kmul(nn,kmadd(ksub(n1,ltet1),Ro131,kmadd(ksub(n2,ltet2),Ro231,knmsub(ltet1,Ro311,kmsub(kmadd(ToReal(-2),ltet3,n3),Ro331,kmul(ltet2,Ro321))))))))),kmadd(n2,kmadd(kmsub(ltet2,n1,kmul(ltet1,n2)),R4p1223,kmadd(kmsub(ltet3,n1,kmul(ltet1,n3)),R4p1323,kmadd(kmsub(ltet3,n2,kmul(ltet2,n3)),R4p2323,kmul(nn,kmadd(ksub(n1,ltet1),Ro132,kmadd(ksub(n2,ltet2),Ro232,knmsub(ltet1,Ro312,kmsub(kmadd(ToReal(-2),ltet3,n3),Ro332,kmul(ltet2,Ro322))))))))),kmul(n3,kmul(nn,kmadd(ksub(n1,ltet1),Ro133,kmadd(ksub(n2,ltet2),Ro233,knmsub(ltet1,Ro313,kmsub(kmadd(ToReal(-2),ltet3,n3),Ro333,kmul(ltet2,Ro323))))))))),kmul(kmadd(ksub(ltet1,n1),kmadd(rm1,Rojo11,kmadd(rm2,Rojo12,kmul(rm3,Rojo13))),kmadd(ksub(ltet2,n2),kmadd(rm1,Rojo21,kmadd(rm2,Rojo22,kmul(rm3,Rojo23))),kmul(kmadd(rm1,Rojo31,kmadd(rm2,Rojo32,kmul(rm3,Rojo33))),ksub(ltet3,n3)))),kmul(nn,nn)))));
    
    CCTK_REAL_VEC Psi3iL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(kmsub(im3,n2,kmul(im2,n3)),kmadd(kmsub(ltet1,n2,kmul(ltet2,n1)),R4p1223,kmadd(kmsub(ltet1,n3,kmul(ltet3,n1)),R4p1323,kmul(R4p2323,kmsub(ltet2,n3,kmul(ltet3,n2))))),kmadd(n1,kmul(nn,kmsub(im1,kmul(ltet1,Ro111),kmul(im2,kmul(Ro121,ksub(n1,ltet1))))),kmadd(im1,kmul(ltet2,kmul(n2,kmul(nn,Ro122))),kmadd(im2,kmul(kmul(n2,kmul(nn,Ro122)),ksub(ltet1,n1)),kmadd(im1,kmul(ltet2,kmul(n3,kmul(nn,Ro123))),kmadd(im2,kmul(kmul(n3,kmul(nn,Ro123)),ksub(ltet1,n1)),kmadd(im1,kmul(ltet3,kmul(n1,kmul(nn,Ro131))),kmadd(n1,knmsub(im2,kmadd(kmsub(ltet2,n1,kmul(ltet1,n2)),R4p1212,kmadd(kmsub(ltet3,n1,kmul(ltet1,n3)),R4p1213,kmul(R4p1223,kmsub(ltet3,n2,kmul(ltet2,n3))))),kmsub(im3,kmadd(kmsub(ltet1,n2,kmul(ltet2,n1)),R4p1213,kmadd(kmsub(ltet1,n3,kmul(ltet3,n1)),R4p1313,kmsub(kmsub(ltet2,n3,kmul(ltet3,n2)),R4p1323,kmul(kmul(nn,Ro131),ksub(n1,ltet1))))),kmul(im1,kmul(kmul(nn,Ro111),ksub(n1,ltet1))))),kmadd(im1,kmul(ltet3,kmul(n2,kmul(nn,Ro132))),kmadd(im3,kmul(kmul(n2,kmul(nn,Ro132)),ksub(ltet1,n1)),kmadd(im1,kmul(ltet3,kmul(n3,kmul(nn,Ro133))),kmadd(im3,kmul(kmul(n3,kmul(nn,Ro133)),ksub(ltet1,n1)),kmadd(im2,kmul(ltet1,kmul(n1,kmul(nn,Ro211))),kmadd(im1,kmul(n1,kmul(kmul(nn,Ro211),ksub(ltet2,n2))),kmadd(im2,kmul(ltet1,kmul(n2,kmul(nn,Ro212))),kmadd(im1,kmsub(n2,kmadd(kmsub(ltet2,n1,kmul(ltet1,n2)),R4p1212,kmadd(kmsub(ltet3,n1,kmul(ltet1,n3)),R4p1213,kmsub(kmsub(ltet3,n2,kmul(ltet2,n3)),R4p1223,kmul(kmul(nn,Ro212),ksub(n2,ltet2))))),kmul(n3,kmadd(kmsub(ltet1,n2,kmul(ltet2,n1)),R4p1213,kmadd(kmsub(ltet1,n3,kmul(ltet3,n1)),R4p1313,kmul(R4p1323,kmsub(ltet2,n3,kmul(ltet3,n2))))))),kmadd(im2,kmul(ltet1,kmul(n3,kmul(nn,Ro213))),kmadd(im1,kmul(kmul(n3,kmul(nn,Ro213)),ksub(ltet2,n2)),kmadd(im2,kmul(ltet2,kmul(n1,kmul(nn,Ro221))),kmadd(im2,kmul(n1,kmul(kmul(nn,Ro221),ksub(ltet2,n2))),kmadd(im2,kmul(ltet2,kmul(n2,kmul(nn,Ro222))),kmadd(n2,kmul(nn,kmsub(im1,kmul(ltet1,Ro112),kmul(im2,kmul(Ro222,ksub(n2,ltet2))))),kmadd(im2,kmul(ltet2,kmul(n3,kmul(nn,Ro223))),kmadd(im2,kmul(kmul(n3,kmul(nn,Ro223)),ksub(ltet2,n2)),kmadd(im2,kmul(ltet3,kmul(n1,kmul(nn,Ro231))),kmadd(im3,kmul(n1,kmul(kmul(nn,Ro231),ksub(ltet2,n2))),kmadd(im2,kmul(ltet3,kmul(n2,kmul(nn,Ro232))),kmadd(n2,kmul(nn,kmsub(im1,kmul(Ro112,ksub(ltet1,n1)),kmul(im3,kmul(Ro232,ksub(n2,ltet2))))),kmadd(im2,kmul(ltet3,kmul(n3,kmul(nn,Ro233))),kmadd(im3,kmul(kmul(n3,kmul(nn,Ro233)),ksub(ltet2,n2)),kmadd(im3,kmul(ltet1,kmul(n1,kmul(nn,Ro311))),kmadd(im1,kmul(n1,kmul(kmul(nn,Ro311),ksub(ltet3,n3))),kmadd(im3,kmul(ltet1,kmul(n2,kmul(nn,Ro312))),kmadd(im1,kmul(n2,kmul(kmul(nn,Ro312),ksub(ltet3,n3))),kmadd(im3,kmul(ltet1,kmul(n3,kmul(nn,Ro313))),kmadd(im1,kmul(n3,kmul(nn,kmsub(ltet1,Ro113,kmul(Ro313,ksub(n3,ltet3))))),kmadd(im3,kmul(ltet2,kmul(n1,kmul(nn,Ro321))),kmadd(im2,kmul(n1,kmul(kmul(nn,Ro321),ksub(ltet3,n3))),kmadd(im3,kmul(ltet2,kmul(n2,kmul(nn,Ro322))),kmadd(im2,kmul(n2,kmul(kmul(nn,Ro322),ksub(ltet3,n3))),kmadd(im3,kmul(ltet2,kmul(n3,kmul(nn,Ro323))),kmadd(n3,kmul(nn,kmsub(im1,kmul(Ro113,ksub(ltet1,n1)),kmul(im2,kmul(Ro323,ksub(n3,ltet3))))),kmadd(im3,kmul(ltet3,kmul(n1,kmul(nn,Ro331))),kmadd(im3,kmul(n1,kmul(kmul(nn,Ro331),ksub(ltet3,n3))),kmadd(im3,kmul(ltet3,kmul(n2,kmul(nn,Ro332))),kmadd(im3,kmul(n2,kmul(kmul(nn,Ro332),ksub(ltet3,n3))),kmadd(im3,kmul(ltet3,kmul(n3,kmul(nn,Ro333))),kmadd(nn,kmsub(im1,kmul(ltet2,kmul(n1,Ro121)),kmul(im3,kmul(n3,kmul(Ro333,ksub(n3,ltet3))))),kmadd(ksub(n1,ltet1),kmul(kmadd(im1,Rojo11,kmadd(im2,Rojo12,kmul(im3,Rojo13))),kmul(nn,nn)),kmadd(ksub(n2,ltet2),kmul(kmadd(im1,Rojo21,kmadd(im2,Rojo22,kmul(im3,Rojo23))),kmul(nn,nn)),kmul(kmul(kmadd(im1,Rojo31,kmadd(im2,Rojo32,kmul(im3,Rojo33))),kmul(nn,nn)),ksub(n3,ltet3))))))))))))))))))))))))))))))))))))))))))))))))))));
    
    CCTK_REAL_VEC Psi2rL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(kmadd(ltet2,kmsub(n1,R4p1212,kmul(n3,R4p1223)),kmul(ltet3,kmsub(n1,R4p1213,kmul(n3,R4p1323)))),kmadd(im1,im2,kmul(rm1,rm2)),kmadd(kmsub(ltet1,kmadd(n2,R4p1212,kmul(n3,R4p1213)),kmul(ltet3,kmadd(n2,R4p1223,kmul(n3,R4p1323)))),kmadd(im1,im2,kmul(rm1,rm2)),kmadd(kmadd(ltet2,kmul(n1,R4p1213),kmadd(ltet2,kmul(n2,R4p1223),kmadd(ltet3,kmul(n1,R4p1313),kmul(ltet3,kmul(n2,R4p1323))))),kmadd(im1,im3,kmul(rm1,rm3)),kmadd(kmadd(ltet1,kmul(n2,R4p1213),kmadd(ltet2,kmul(n2,R4p1223),kmadd(ltet1,kmul(n3,R4p1313),kmul(ltet2,kmul(n3,R4p1323))))),kmadd(im1,im3,kmul(rm1,rm3)),kmadd(knmsub(n1,kmadd(ltet2,R4p1223,kmul(ltet1,R4p1213)),kmadd(ltet1,knmsub(n1,R4p1213,kmsub(n3,R4p1323,kmul(n2,R4p1223))),kmadd(ltet2,kmul(n3,R4p2323),kmul(ltet3,kmadd(n1,R4p1323,kmul(n2,R4p2323)))))),kmadd(im2,im3,kmul(rm2,rm3)),knmsub(kmadd(ltet2,kmul(n2,R4p1212),kmadd(ltet3,kmul(n2,R4p1213),kmadd(ltet2,kmul(n3,R4p1213),kmul(ltet3,kmul(n3,R4p1313))))),kmadd(im1,im1,kmul(rm1,rm1)),knmsub(kmadd(n1,kmsub(ltet1,R4p1212,kmul(ltet3,R4p1223)),kmul(n3,kmsub(ltet3,R4p2323,kmul(ltet1,R4p1223)))),kmadd(im2,im2,kmul(rm2,rm2)),knmsub(kmadd(ltet1,kmul(n1,R4p1313),kmadd(ltet2,kmul(n1,R4p1323),kmadd(ltet1,kmul(n2,R4p1323),kmul(ltet2,kmul(n2,R4p2323))))),kmadd(im3,im3,kmul(rm3,rm3)),kmsub(nn,kmadd(n3,kmul(rm1,kmul(rm2,Ro213)),kmadd(rm1,kmsub(rm2,kmsub(n2,Ro122,kmul(ltet2,Ro221)),kmul(ltet2,kmul(rm3,Ro123))),kmadd(rm3,kmsub(n1,kmul(rm1,Ro131),kmul(ltet2,kmul(rm2,Ro223))),kmadd(n1,kmul(rm2,kmul(rm3,Ro231)),kmadd(rm1,kmsub(n2,kmul(rm3,Ro132),kmul(ltet3,kmul(rm2,Ro231))),kmadd(n2,kmul(rm2,kmul(rm3,Ro232)),kmadd(n3,kmul(rm2,kmul(rm3,Ro233)),kmadd(im2,kmul(im3,kmsub(n1,Ro231,kmul(ltet3,Ro233))),kmadd(rm3,kmsub(n3,kmul(rm1,Ro133),kmul(ltet3,kmul(rm2,Ro233))),kmadd(n1,kmul(rm1,kmul(rm3,Ro311)),kmadd(n2,kmul(rm1,kmul(rm3,Ro312)),kmadd(n3,kmul(rm1,kmul(rm3,Ro313)),kmadd(im2,kmul(im3,kmul(n1,Ro321)),kmadd(n1,kmul(rm2,kmul(rm3,Ro321)),kmadd(rm1,kmsub(rm2,kmsub(n1,Ro121,kmadd(ltet3,Ro132,kmul(ltet2,Ro122))),kmul(ltet2,kmul(rm3,Ro321))),kmadd(im2,kmul(im3,kmul(n2,Ro322)),kmadd(n2,kmul(rm2,kmul(rm3,Ro322)),kmadd(im2,kmul(im3,kmsub(n2,Ro232,kmul(ltet2,Ro322))),kmadd(rm2,kmsub(n1,kmul(rm1,Ro211),kmul(ltet2,kmul(rm3,Ro322))),kmadd(n3,kmul(rm2,kmul(rm3,Ro323)),kmadd(rm1,kmsub(n3,kmul(rm2,Ro123),kmul(ltet3,kmul(rm3,kadd(Ro133,Ro331)))),kmadd(im1,kmadd(im2,kmadd(ksub(n2,ltet2),Ro122,kmadd(n3,Ro123,knmsub(ltet1,kadd(Ro112,Ro211),kmadd(n1,kadd(Ro121,Ro211),kmadd(n2,Ro212,kmsub(n3,Ro213,kmadd(ltet3,kadd(Ro132,Ro231),kmul(ltet2,Ro221)))))))),kmul(im3,kmadd(n1,Ro131,kmadd(n2,Ro132,kmadd(ksub(n3,ltet3),Ro133,kmadd(n1,Ro311,knmsub(ltet1,kadd(Ro113,Ro311),kmadd(n2,Ro312,kmsub(n3,Ro313,kmadd(ltet3,Ro331,kmul(ltet2,kadd(Ro123,Ro321)))))))))))),kmadd(im2,kmul(im3,kmsub(n3,Ro233,kmul(ltet3,Ro332))),kmadd(rm2,kmsub(n2,kmul(rm1,Ro212),kmul(ltet3,kmul(rm3,Ro332))),kmadd(kmadd(ksub(n1,ltet1),Ro111,kmadd(n2,Ro112,kmsub(n3,Ro113,kmadd(ltet3,Ro131,kmul(ltet2,Ro121))))),kmul(im1,im1),kmadd(kmsub(n1,Ro221,kmul(ltet2,Ro222)),kmul(im2,im2),kmadd(kmsub(n2,Ro222,kmul(ltet3,Ro232)),kmul(im2,im2),kmadd(Ro223,kmsub(n3,kmul(im2,im2),kmul(im2,kmul(im3,ltet2))),kmadd(n2,kmul(Ro332,kmul(im3,im3)),kmadd(n3,kmul(Ro333,kmul(im3,im3)),kmadd(kmsub(n1,Ro331,kmul(ltet3,Ro333)),kmul(im3,im3),kmadd(n3,kmul(Ro113,kmul(rm1,rm1)),kmadd(kmsub(n1,Ro111,kmul(ltet2,Ro121)),kmul(rm1,rm1),kmadd(kmsub(n2,Ro112,kmul(ltet3,Ro131)),kmul(rm1,rm1),kmadd(kmsub(n1,Ro221,kmul(ltet2,Ro222)),kmul(rm2,rm2),kmadd(n3,kmul(Ro223,kmul(rm2,rm2)),kmadd(kmsub(n2,Ro222,kmul(ltet3,Ro232)),kmul(rm2,rm2),kmadd(Ro323,kmsub(im2,kmul(im3,n3),kmul(ltet2,kmadd(rm3,rm3,kmul(im3,im3)))),kmadd(n2,kmul(Ro332,kmul(rm3,rm3)),kmadd(n3,kmul(Ro333,kmul(rm3,rm3)),kmsub(kmsub(n1,Ro331,kmul(ltet3,Ro333)),kmul(rm3,rm3),kmul(ltet1,kmadd(rm1,kmul(rm2,kadd(Ro112,Ro211)),kmadd(rm2,kmul(rm3,Ro213),kmadd(rm1,kmul(rm3,kadd(Ro113,Ro311)),kmadd(rm2,kmul(rm3,Ro312),kmadd(im2,kmul(im3,kadd(Ro213,Ro312)),kmadd(Ro212,kmul(im2,im2),kmadd(Ro313,kmul(im3,im3),kmadd(Ro111,kmul(rm1,rm1),kmadd(Ro212,kmul(rm2,rm2),kmul(Ro313,kmul(rm3,rm3))))))))))))))))))))))))))))))))))))))))))))))))))))),kmul(kmadd(im1,kmul(im2,kadd(Rojo12,Rojo21)),kmadd(rm1,kmul(rm2,kadd(Rojo12,Rojo21)),kmadd(im2,kmul(im3,Rojo23),kmadd(rm2,kmul(rm3,Rojo23),kmadd(im1,kmul(im3,kadd(Rojo13,Rojo31)),kmadd(rm1,kmul(rm3,kadd(Rojo13,Rojo31)),kmadd(im2,kmul(im3,Rojo32),kmadd(rm2,kmul(rm3,Rojo32),kmadd(Rojo11,kmul(im1,im1),kmadd(Rojo22,kmul(im2,im2),kmadd(Rojo33,kmul(im3,im3),kmadd(Rojo11,kmul(rm1,rm1),kmadd(Rojo22,kmul(rm2,rm2),kmul(Rojo33,kmul(rm3,rm3))))))))))))))),kmul(nn,nn)))))))))));
    
    CCTK_REAL_VEC Psi2iL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(knmsub(n1,kmadd(ltet3,R4p1213,kmul(ltet2,R4p1212)),kmadd(ltet1,kmadd(n2,R4p1212,kmul(n3,R4p1213)),kmul(R4p1223,kmsub(ltet2,n3,kmul(ltet3,n2))))),kmsub(im2,rm1,kmul(im1,rm2)),kmadd(kmadd(kmsub(ltet1,n2,kmul(ltet2,n1)),R4p1213,kmadd(kmsub(ltet1,n3,kmul(ltet3,n1)),R4p1313,kmul(R4p1323,kmsub(ltet2,n3,kmul(ltet3,n2))))),kmsub(im3,rm1,kmul(im1,rm3)),kmadd(knmsub(n1,kmadd(ltet2,R4p1223,kmul(ltet1,R4p1213)),kmadd(ltet1,kmadd(n1,R4p1213,kmul(n2,R4p1223)),kmadd(ltet1,kmul(n3,R4p1323),kmsub(ltet2,kmul(n3,R4p2323),kmul(ltet3,kmadd(n1,R4p1323,kmul(n2,R4p2323))))))),kmsub(im3,rm2,kmul(im2,rm3)),kmsub(kmadd(rm1,kmadd(im2,ksub(Rojo12,Rojo21),kmul(im3,ksub(Rojo13,Rojo31))),kmadd(im1,kmadd(rm2,ksub(Rojo21,Rojo12),kmul(rm3,ksub(Rojo31,Rojo13))),kmadd(im3,kmul(rm2,ksub(Rojo23,Rojo32)),kmul(im2,kmul(rm3,ksub(Rojo32,Rojo23)))))),kmul(nn,nn),kmul(nn,kmadd(im1,knmsub(rm2,kmadd(kadd(ltet2,n2),Ro122,kmadd(ltet3,Ro132,kmul(n3,Ro123))),knmsub(rm3,kmadd(ltet2,Ro123,kmadd(kadd(ltet3,n3),Ro133,kmul(n2,Ro132))),kmadd(ltet1,kmul(rm2,ksub(Ro211,Ro112)),kmadd(n1,kmul(rm2,ksub(Ro211,Ro121)),kmadd(n2,kmul(rm2,Ro212),kmadd(n3,kmul(rm2,Ro213),kmadd(ltet2,kmul(rm2,Ro221),kmadd(ltet3,kmul(rm2,Ro231),kmadd(ltet1,kmul(rm3,ksub(Ro311,Ro113)),kmadd(n1,kmul(rm3,ksub(Ro311,Ro131)),kmadd(n2,kmul(rm3,Ro312),kmadd(n3,kmul(rm3,Ro313),kmadd(ltet2,kmul(rm3,Ro321),kmul(ltet3,kmul(rm3,Ro331))))))))))))))),kmadd(im2,kmadd(rm1,kmadd(ltet1,ksub(Ro112,Ro211),kmadd(n1,ksub(Ro121,Ro211),kmadd(n2,ksub(Ro122,Ro212),kmadd(n3,ksub(Ro123,Ro213),kmadd(ltet2,ksub(Ro122,Ro221),kmul(ltet3,ksub(Ro132,Ro231))))))),knmsub(rm3,kmadd(ltet2,Ro223,kmadd(kadd(ltet3,n3),Ro233,kmul(n2,Ro232))),kmadd(ltet1,kmul(rm3,ksub(Ro312,Ro213)),kmadd(n1,kmul(rm3,ksub(Ro321,Ro231)),kmadd(ltet2,kmul(rm3,Ro322),kmadd(n2,kmul(rm3,Ro322),kmadd(n3,kmul(rm3,Ro323),kmul(ltet3,kmul(rm3,Ro332))))))))),kmul(im3,kmadd(rm1,kmadd(kadd(ltet3,n3),Ro133,kmadd(ltet1,ksub(Ro113,Ro311),kmadd(n1,ksub(Ro131,Ro311),kmadd(n2,ksub(Ro132,Ro312),knmsub(n3,Ro313,kmsub(ltet2,ksub(Ro123,Ro321),kmul(ltet3,Ro331))))))),kmul(rm2,kmadd(kadd(ltet3,n3),Ro233,kmadd(ltet1,ksub(Ro213,Ro312),kmadd(n1,ksub(Ro231,Ro321),kmadd(ltet2,ksub(Ro223,Ro322),kmsub(n2,ksub(Ro232,Ro322),kmadd(ltet3,Ro332,kmul(n3,Ro323)))))))))))))))));
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_WeylScal4_psis_calc_Nth
  DECLARE_CCTK_ARGUMENTS_CHECKED(WeylScal4_psis_calc_Nth);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
