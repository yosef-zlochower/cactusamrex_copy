...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_WeylScal4_psis_calc_2nd_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(WeylScal4_psis_calc_2nd_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_WeylScal4_psis_calc_2nd
  DECLARE_CCTK_ARGUMENTS_CHECKED(WeylScal4_psis_calc_2nd);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
